            ...
            <div className="message">
                <div className="m1">
                    ...
                    <div className="m-text">
                        <h1>AI powered diagnostic<br/>tools &nbsp;<img src={mh1} alt="" /></h1>
                ...
                <div className="m2">
                    ...
                    <div className="m-text">
                        <h1>Our shop for all of your<br/>garden needs &nbsp;<img src={mh2} alt="" /></h1>
                ...
                <div className="m3">
                    ...
                    <div className="m-text">
                        <h1>Need a helping hand?<br/>Talk to our experts &nbsp;<img src={mh3} alt="" /></h1>
